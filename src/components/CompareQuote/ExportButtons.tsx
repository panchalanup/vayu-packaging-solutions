...
export function ExportButtons({ result, input }: ExportButtonsProps) {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <Button onClick={handleWhatsAppShare} variant="outline" size="sm" className="bg-green-50 hover:bg-green-100 text-green-700 hover:text-green-800 border-green-200 hover:border-green-300">
      ...
      <Button onClick={handleEmailCopy} variant="outline" size="sm">
